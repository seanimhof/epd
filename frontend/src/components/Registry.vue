...
<template>
    ...
    <div class="grid grid-cols-4 gap-4 max-w-full w-full">
      ...
      <div class="bg-gray-800 p-6 rounded-lg shadow-md">
        ...
        <input v-model="epdBirthdateSearch" type="date" placeholder="Birthdate" class="border px-3 py-2 w-full rounded mb-4 text-white" />
      ...
      <div class="bg-gray-800 p-6 rounded-lg shadow-md">
        ...
        <input v-model="epdBirthdateInsert" type="date" placeholder="Birthdate" class="border px-3 py-2 w-full rounded mb-4 text-white" />
      ...
      <div class="bg-gray-800 p-6 rounded-lg shadow-md">
        ...
        <input v-model="epdBirthdateUpdate" type="date" placeholder="Birthdate" class="border px-3 py-2 w-full rounded mb-4 text-white" />
      ...
      <div class="bg-gray-800 p-6 rounded-lg shadow-md">
        ...
        <input v-model="epdBirthdateDelete" type="date" placeholder="Birthdate" class="border px-3 py-2 w-full rounded mb-4 text-white" />
