...
Execute the following script if you are running a linux / macos systen. Ensure all technologies are installed.
```shell

```

# Getting Started (I know my stuff around linux)
For the following section, you need to know your way around your system.
